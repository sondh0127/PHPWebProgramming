...
<div class="row">
  <div class="col-sm-12">
    <div class="btn-group pull-right m-t-15">
      <a href="{{url('/employee')}}" class="btn btn-default waves-effect">All Employee <span class="m-l-5"></span></a>
    </div>
            ...
            <div class="form-group">
              ...
              <div class="col md-10">
                <div id="image-preview"
                  style="background-image: url({{$employee->image != "" || null ? $employee->photo() : url('/img_assets/avatar.png')}})">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input type="password" minlength="5" maxlength="20" name="password" placeholder="Password"
                  class="form-control" value="" id="pass1">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <select name="role" id="" class="form-control" required>
                  ...
                  <option value="2" {{$employee->role == 2 ? 'selected' :''}}>Shop Manager</option>
                  <option value="3" {{$employee->role == 3 ? 'selected' :''}}>Kitchen</option>
                  <option value="4" {{$employee->role == 4 ? 'selected' :''}}>Waiter</option>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <div class="checkbox checkbox-primary">
                  <input id="checkbox0" name="status" type="checkbox" {{$employee->active == 1 ? 'checked' : ''}}>
                  <label for="checkbox0">
                    Active
                  </label>
                </div>
...
$(document).ready(function(e) {
  ...
  addEmployeeForm.on('submit', function(e) {
    ...
    $(this).speedPost('/update-employee/' + id, formData, message = {
      success: {
        header: 'Employee update successfully',
